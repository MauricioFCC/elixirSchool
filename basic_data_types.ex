# Integers: Soporta; Binarios, Octal y hexadecimal

0b0110 # 6
0o644 # 420
0x1F # 31

# Floats: Los números de punto flotante requieren un decimal después de al menos un dígito; tienen doble precisión de 64 bits y admiten `e` para valores de exponente:

3.14 # 3.14
.14 # ** (SyntaxError) iex:2: syntax error before: '.'
1.0e-10 # 1.0e-10

# Booleans: Elixir soporta `true` verdadero`false`  y `nil` falso

true # true
false # false

# Atoms: Es una constante cuyo nombre es su valor. Son sinónimos de símbolos. `true` y `false` también son átomos.
...
# Strings: se usa codificado en UTF-8 y entre comillas dobles:
